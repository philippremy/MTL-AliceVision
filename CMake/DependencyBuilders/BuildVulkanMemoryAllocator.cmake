...
macro(build_vma)
    ...
    set(CURRENT_DEPENDENCY VulkanMemoryAllocator)
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/share/cmake/VulkanMemoryAllocator/VulkanMemoryAllocatorConfig.cmake")
