...
macro(build_suitesparse)

    set(CURRENT_DEPENDENCY SuiteSparse)
    ...
    execute_process(COMMAND ${CMAKE_COMMAND}
            ...
            "-DSUITESPARSE_ENABLE_PROJECTS=cholmod;spqr"
    ...
    # Patch the CMake Config Files to not emit messages
    set(SUITESPARSE_CONFIG_FILES
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/AMD/AMDConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/CAMD/CAMDConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/CCOLAMD/CCOLAMDConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/CHOLMOD/CHOLMODConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/COLAMD/COLAMDConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/SPQR/SPQRConfig.cmake"
            "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/SuiteSparse_config/SuiteSparse_configConfig.cmake"
    )

    foreach(CONFIG_FILE IN LISTS SUITESPARSE_CONFIG_FILES)
        ...
        string(REGEX REPLACE "message *\\( *STATUS" "# message(STATUS suppressed" FILE_PATCHED "${FILE_CONTENTS}")
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/SuiteSparse_configConfig.cmake")
