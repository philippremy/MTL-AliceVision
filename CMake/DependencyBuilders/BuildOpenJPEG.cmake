...
macro(build_openjpeg)

    set(CURRENT_DEPENDENCY OpenJPEG)
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/OpenJPEGConfig.cmake")
