...
macro(build_apriltag)

    set(CURRENT_DEPENDENCY AprilTag)
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/apriltag/cmake/apriltagConfig.cmake")
