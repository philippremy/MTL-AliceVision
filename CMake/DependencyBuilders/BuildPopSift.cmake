...
macro(build_popsift)
    ...
    set(CURRENT_DEPENDENCY PopSift)
    ...
    if(NOT EXISTS "${DEPENDENCY_GIT_HEAD}")
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE}
                clone --depth 1
                https://github.com/alicevision/popsift.git
    ...
    execute_process(COMMAND ${CMAKE_COMMAND}
            ...
            -DPopSift_USE_NVTX_PROFILING=OFF
            -DPopSift_ERRCHK_AFTER_KERNEL=OFF
            -G "${CMAKE_GENERATOR}"
            ..
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/PopSiftConfig.cmake")
