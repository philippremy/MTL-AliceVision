...
macro(build_coinutils)

    set(CURRENT_DEPENDENCY CoinUtils)
    ...
    if(NOT EXISTS "${DEPENDENCY_GIT_HEAD}")
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE}
                clone --depth 1
                https://github.com/alicevision/CoinUtils.git
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/CoinUtilsConfig.cmake")
