...
macro(build_osi)
    ...
    if(NOT EXISTS "${DEPENDENCY_GIT_HEAD}")
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE}
                clone --depth 1
                https://github.com/alicevision/Osi.git
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/OsiConfig.cmake")
