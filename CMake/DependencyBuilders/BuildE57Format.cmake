...
macro(build_e57format)

    set(CURRENT_DEPENDENCY E57Format)
    ...
    if(NOT EXISTS "${DEPENDENCY_GIT_HEAD}")
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE}
                clone --depth 1
                https://github.com/asmaloney/libE57Format.git
    ...
    file(GLOB_RECURSE ${CURRENT_DEPENDENCY}_CONFIG "${CMAKE_SOURCE_DIR}/External/Products/lib/cmake/e57format-config.cmake")
