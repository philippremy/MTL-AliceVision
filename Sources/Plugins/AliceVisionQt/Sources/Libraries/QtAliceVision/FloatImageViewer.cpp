...
#include <QtAliceVision/FloatTexture.hpp>
...
QSGMaterialShader* FloatImageViewerMaterial::createShader(QSGRendererInterface::RenderMode) const { return new FloatImageViewerMaterialShader; }
