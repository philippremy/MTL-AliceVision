...
#include <AVRobustEstimation/NACRansac.hpp>
#include <AVMultiview/triangulation/triangulationDLT.hpp>
#include <AVMultiview/relativePose/RelativeSphericalKernel.hpp>
#include <AVMultiview/relativePose/RotationSphericalKernel.hpp>
