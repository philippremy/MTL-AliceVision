...
#include <AVFeature/regionsFactory.hpp>
#include <AVFeature/akaze/AKAZE.hpp>
#include <AVFeature/akaze/descriptorLIOP.hpp>
#include <AVFeature/akaze/descriptorMLDB.hpp>
#include <AVFeature/akaze/descriptorMSURF.hpp>
    ...
    void allocate(std::unique_ptr<Regions>& regions) const override
    {
        switch (_params.akazeDescriptorType)
        {
            case AKAZE_MSURF:
                ...
                break;
            case AKAZE_LIOP:
                regions.reset(new AKAZE_Liop_Regions);
                break;
            case AKAZE_MLDB:
                regions.reset(new AKAZE_BinaryRegions);
                break;
        }
    }
