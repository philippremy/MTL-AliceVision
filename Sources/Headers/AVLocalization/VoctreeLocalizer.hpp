...
#include <AVVoctree/Database.hpp>
#include <AVMatching/RegionsMatcher.hpp>
#include <AVLocalization/reconstructed_regions.hpp>
#include <AVLocalization/LocalizationResult.hpp>
#include <AVLocalization/ILocalizer.hpp>
#include <AVLocalization/BoundedBuffer.hpp>
...
class VoctreeLocalizer : public ILocalizer
{
  ...
  public:
    ...
    void setCudaPipe(int i) override { _cudaPipe = i; }
  ...
  private:
     ...
     */
    bool initDatabase(const std::string& vocTreeFilepath, const std::string& weightsFilepath, const std::string& featFolder);
