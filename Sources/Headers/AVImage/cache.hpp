...
class CachedTile
{
  ...
  public:
    ...
    CachedTile(const std::shared_ptr<TileCacheManager>& manager,
               size_t uid,
               size_t tileWidth,
               size_t tileHeight,
               size_t width,
    ...
    size_t getTileWidth() const { return _tileWidth; }

    size_t getTileHeight() const { return _tileHeight; }

    size_t getRequiredWidth() const { return _requiredWidth; }

    size_t getRequiredHeight() const { return _requiredHeight; }
    ...
    */
     ...
     */
    void setData(std::unique_ptr<unsigned char>&& data) { _data = std::move(data); }
     ...
     */
    std::unique_ptr<unsigned char> getData() { return std::move(_data); }
    ...
    */
    ...
    using MRUType = boost::multi_index::multi_index_container<
      ...
      boost::multi_index::indexed_by<boost::multi_index::sequenced<>,
                                     boost::multi_index::hashed_unique<boost::multi_index::member<MRUItem, size_t, &MRUItem::objectId>>>>;
