...
#include <AVSensorDB/Datasheet.hpp>
#include <AVCamera/IntrinsicInitMode.hpp>
#include <AVLensCorrectionProfile/lcp.hpp>

#include <AVSfMData/ImageInfo.hpp>
#include <AVSfMData/exif.hpp>
#include <AVSfMData/ExposureSetting.hpp>
