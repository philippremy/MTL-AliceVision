...
BOOST_AUTO_TEST_CASE(read_unexisting)
{
    ...
    const std::string filename = string("") + "/unexisting.jpg";
...
{
    Image<unsigned char> image;
    const std::string jpg_filename = string("") + "/AVImage_Test/two_pixels_monochrome.jpg";
...
BOOST_AUTO_TEST_CASE(read_jpg_rgb)
{
    ...
    const std::string jpg_filename = string("") + "/AVImage_Test/two_pixels_color.jpg";
    BOOST_CHECK_NO_THROW(readImage(jpg_filename, image, image::EImageColorSpace::NO_CONVERSION));
    BOOST_CHECK_EQUAL(2, image.width());
    BOOST_CHECK_EQUAL(1, image.height());
...
{
    Image<unsigned char> image;
    const std::string png_filename = string("") + "/AVImage_Test/two_pixels_monochrome.png";
...
{
    Image<RGBColor> image;
    const std::string png_filename = string("") + "/AVImage_Test/two_pixels_color.png";
    BOOST_CHECK_NO_THROW(readImage(png_filename, image, image::EImageColorSpace::NO_CONVERSION));
    BOOST_CHECK_EQUAL(2, image.width());
    BOOST_CHECK_EQUAL(1, image.height());
    BOOST_CHECK_EQUAL(3, image.depth());
...
{
    Image<unsigned char> image;
    const std::string pgm_filename = string("") + "/AVImage_Test/two_pixels.pgm";
...
{
    Image<unsigned char> image;
    const std::string pgm_filename = string("") + "/AVImage_Test/two_pixels_gray.pgm";
    BOOST_CHECK_NO_THROW(readImage(pgm_filename, image, image::EImageColorSpace::NO_CONVERSION));
    BOOST_CHECK_EQUAL(2, image.width());
    BOOST_CHECK_EQUAL(1, image.height());
    BOOST_CHECK_EQUAL(1, image.depth());
...
{
    Image<RGBColor> image;
    const std::string ppm_filename = string("") + "/AVImage_Test/two_pixels.ppm";
