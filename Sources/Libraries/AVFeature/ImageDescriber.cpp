...
#include <AVFeature/sift/ImageDescriber_SIFT.hpp>
#include <AVFeature/sift/ImageDescriber_SIFT_vlfeatFloat.hpp>
#include <AVFeature/sift/ImageDescriber_DSPSIFT_vlfeat.hpp>
#include <AVFeature/akaze/ImageDescriber_AKAZE.hpp>
#include <AVUtils/filesIO.hpp>

#if ALICEVISION_IS_DEFINED(ALICEVISION_HAVE_CCTAG)
    #include <AVFeature/cctag/ImageDescriber_CCTAG.hpp>
#endif  // ALICEVISION_HAVE_CCTAG

#if ALICEVISION_IS_DEFINED(ALICEVISION_HAVE_APRILTAG)
    #include <AVFeature/apriltag/ImageDescriber_APRILTAG.hpp>
#endif  // ALICEVISION_HAVE_APRILTAG

#if ALICEVISION_IS_DEFINED(ALICEVISION_HAVE_OPENCV)
    #include <AVFeature/openCV/ImageDescriber_SIFT_OCV.hpp>
    #include <AVFeature/openCV/ImageDescriber_AKAZE_OCV.hpp>
