...
void BuildLinearProblem(LPConstraints& cstraint)
{
    ...
    cstraint._constraintMat << 120, 210, 110, 30, 1, 1, 1, 0, 0, 1;
    ...
    fill(cstraint._vec_bounds.begin(), cstraint._vec_bounds.end(), std::make_pair((double)-1e+30, (double)1e+30));
}
...
void BuildSparseLinearProblem(LPConstraintsSparse& cstraint)
{
    ...
    fill(cstraint._vec_bounds.begin(), cstraint._vec_bounds.end(), std::make_pair(0.0, (double)1e+30));
