...
BOOST_AUTO_TEST_CASE(exportGraphToMapSubgraphs_CC_Subgraph)
{
    ...
    // four
    lemon::ListGraph::Node d = graph.addNode(), e = graph.addNode(), f = graph.addNode(), g = graph.addNode();
    graph.addEdge(d, e);
    graph.addEdge(e, f);
    graph.addEdge(f, g);
    graph.addEdge(g, d);
    ...
    // five
    lemon::ListGraph::Node h = graph.addNode(), i = graph.addNode(), j = graph.addNode(), k = graph.addNode(), l = graph.addNode();
    graph.addEdge(h, i);
    graph.addEdge(i, j);
    graph.addEdge(j, k);
    graph.addEdge(i, l);
