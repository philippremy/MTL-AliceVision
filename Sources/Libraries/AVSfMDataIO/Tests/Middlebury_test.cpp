...
#include <AVSfMDataIO/middlebury.hpp>
...
BOOST_AUTO_TEST_CASE(middlebury_parse)
{
    ...
    const auto matKGT = (Mat3() << 1520.400000, 0.000000, 302.320000, 0.000000, 1525.900000, 246.870000, 0.000000, 0.000000, 1.000000).finished();
    const auto rotationGT = (Mat3() << 0.10793659924390045000,
                             -0.99055951509200579000,
                             0.08450761861721302300,
                             -0.32994878599451571000,
                             0.04449292035991074500,
                             0.94294972223262863000,
                             -0.93780781035583538000,
                             -0.12966197244580752000,
                             -0.32203149494584499000)
                              .finished();
    ;
